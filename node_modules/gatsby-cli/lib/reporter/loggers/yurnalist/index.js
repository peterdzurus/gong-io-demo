...
function generatePageTreeToConsole(yurnalist, state) {
  ...
  yurnalist.log(``);
  yurnalist.log((0, _boxen.default)([`  (SSG) Generated at build time`, `D (DSG) Defered static generation - page generated at runtime`, `∞ (SSR) Server-side renders at runtime (uses getServerDate)`, `λ (Function) Gatsby function`].join(`\n`), {
    padding: 1,
    margin: {
      left: 2,
      right: 2,
